...
try:
    ...
    nfl.import_weekly_data(range(1999, 2022)).\
        to_sql('weekly', conn, index=False, if_exists='replace')

    nfl.import_seasonal_data(range(1999,2022)).\
